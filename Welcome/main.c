...
int main() {
    ...
    printf("\033[36mNote that first challenge in each categories should be easy and could be solved without prior knowledge.\n");
    printf("If you Break ALL every single challenge, feel free to contact me for a special prize! (only the first one)\n");
    printf("\n");
    printf("\033[32mELF\n");
    printf("\033[36mQuite striaght forward, reverse ELF file.\n");
    printf("\n");
    printf("\033[32mUnity Game Hacking\n");
    printf("\033[36mGenaral game hacking skill and something specific for unity games.\n");
    printf("\n");
